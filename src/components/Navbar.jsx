...
const Navbar = () => {
    ...
    return (
      <div className="fixed w-full z-10 bg-backgroundColor text-white shadow-lg">
        ...
        <div
          className={`${menu ? "translate-x-0" : "-translate-x-full"} lg:hidden flex flex-col absolute bg-backgroundColor text-white left-0 top-16 font-semibold text-center pt-8 pb-4 gap-8 w-full transition-transform duration-300`}
        >
          ...
          <Link to="/doctors" className="hover:text-hoverColor" onClick={closeMenu}>
            Doctors
          </Link>
